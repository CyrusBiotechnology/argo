...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ErrorResult) DeepCopyInto(out *ErrorResult) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ErrorResult.
func (in *ErrorResult) DeepCopy() *ErrorResult {
	if in == nil {
		return nil
	}
	out := new(ErrorResult)
