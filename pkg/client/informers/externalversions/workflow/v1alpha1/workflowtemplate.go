...
import (
	...
	workflowv1alpha1 "github.com/cyrusbiotechnology/argo/pkg/apis/workflow/v1alpha1"
	...
	v1alpha1 "github.com/cyrusbiotechnology/argo/pkg/client/listers/workflow/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ArgoprojV1alpha1().WorkflowTemplates(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ArgoprojV1alpha1().WorkflowTemplates(namespace).Watch(options)
			},
		},
