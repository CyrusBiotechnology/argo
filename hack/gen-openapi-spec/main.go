...
// e.g.:
// github.com/CyrusBiotechnology/argo/pkg/apis/workflow/v1alpha1.Workflow
// to:
// io.argoproj.workflow.v1alpha1.Workflow
func swaggify(name string) string {
	name = strings.Replace(name, "github.com/CyrusBiotechnology/argo/pkg/apis", "argoproj.io", -1)
